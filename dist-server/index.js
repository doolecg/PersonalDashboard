...
if (isAuthRequired() && !isSupabaseAuthConfigured()) {
    logger.error("Auth is required but Supabase is not configured. Set SUPABASE_URL and SUPABASE_ANON_KEY (and SUPABASE_SERVICE_ROLE_KEY for storage), or set AUTH_ENABLED=false for local development only.");
